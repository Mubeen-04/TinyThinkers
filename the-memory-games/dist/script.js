...
class PlayArea extends React.Component {
  ...
  constructor(props) {
    super(props);_defineProperty(this, "tiles", [{ name: "face-with-tears-of-joy", accent: "#ffcc33", icon: "😂" }, { name: "turkey", accent: "rgb(171, 153, 142)", icon: "🦃" }, { name: "monkey-face", accent: "rgb(151, 123, 75)", icon: "🐵" }, { name: "ear-of-maize", accent: "rgb(138, 181, 115)", icon: "🌽" }, { name: "snowman-without-snow", accent: "#ffffff", icon: "⛄" }, { name: "beer-mug", accent: "goldenrod", icon: "🍺" }, { name: "thinking-face", accent: "yellow", icon: "🤔" }, { name: "racing-car", accent: "#DC143C", icon: "🏎️" }]);
